<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<header>
		<hgroup>
			<h1>学生管理</h1>
			<h2>学生总数 : <?php echo ($count); ?></h2>
		</hgroup>
	</header>
	
	<div class="content">
			<a href="/biye/index.php/Teacher/Student/addStudent"><button>添加学生</button></a>
				<form style="display:none" action="/biye/index.php/Teacher/Student/assign_student" method="post" enctype="multipart/form-data">
				...
				<thead>
					...
					<tbody>
						...
						<?php if(is_array($type)): foreach($type as $key=>$vo): ?><tr>
								<td style="padding-left: 50px;"><?php echo ($vo["Snum"]); ?></td>
								...
								<td><a href="/biye/index.php/Teacher/Student/changePwd/Snum/<?php echo ($vo["Snum"]); ?>" style="margin-left: 15px;">修改密码</a>
