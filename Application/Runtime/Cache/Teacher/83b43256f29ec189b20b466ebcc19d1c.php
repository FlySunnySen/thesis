<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
		...
		<nav>
			<ul>
				...
				<?php if(in_array(($role), explode(',',"1,2"))): ?><li class="section">
							...
							<li>
								<a href="/biye/index.php/Teacher/Score/Rgrade"><span class="icon">&#9881;</span>个人信息修改</a>
							</li>
	...
	<form action="/biye/index.php/Teacher/TeaInformation/changePwd" class="field-wrap" method="post">
		<br />
	
		<input type="password" name="oldpwd" placeholder="请输入原密码" required="required"/><br />
		<input type="password" name="pwd" placeholder="请输入新密码" required="required" /><br />
	
		<input type="submit" class="page-btn" value="确认">
