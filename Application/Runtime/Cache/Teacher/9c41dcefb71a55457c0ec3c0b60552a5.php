<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<body>
		...
		<div>
			...
			<form action="/biye/index.php/Teacher/Config/openSystem" method="post">
				<br />
					<select id="myYear" name="myYear">
						
		
					</select> 
					<button type="submit" class="button blue">开放</button>
					<button type="submit" class="button" formaction="/biye/index.php/Teacher/Config/closeSystem">维护</button>
					<button type="submit" class="button" formaction="/biye/index.php/Teacher/Config/exportData">导出数据</button>
		    </form>
