<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<a href="/biye/index.php/Teacher/TeacherManage/addERG" ><button style="margin-top: 15px;" class="blue">添加教研室</button></a>
	<table id="myTable">
		<tr>
			<td>编号</td>
			<td>名称</td>
		...
		<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
					...
					<td><?php echo ($vo["ERG_group"]); ?></td>
					<td><?php echo ($vo["ERG_name"]); ?></td>
					<td>
						<a href="/biye/index.php/Teacher/TeacherManage/editERG/ERG_group/<?php echo ($vo["ERG_group"]); ?>">修改</a>
						<a href="/biye/index.php/Teacher/TeacherManage/delERG/ERG_group/<?php echo ($vo["ERG_group"]); ?>" style="margin-left: 15px;">删除</a>
					</td>
