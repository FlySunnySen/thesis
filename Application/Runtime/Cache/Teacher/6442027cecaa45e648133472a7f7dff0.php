	...
	<div class="content">
					...
					<table id="myTable">
						...
						<?php if(is_array($defenseinfo)): foreach($defenseinfo as $key=>$vo): ?><tr>
							...
							<td>
								<a href="/biye/index.php/Teacher/TeacherDefense/showAddViewTeacher/defense_group/<?php echo ($vo["defense_group"]); ?>/year/<?php echo ($vo["year"]); ?>/ERG_group/<?php echo ($vo["ERG_group"]); ?>">分配论文评阅</a>
							<a href="/biye/index.php/Teacher/TeacherDefense/RscoreSum/defense_group/<?php echo ($vo["defense_group"]); ?>/year/<?php echo ($vo["year"]); ?>/ERG_group/<?php echo ($vo["ERG_group"]); ?>" style="margin-left: 15px;">答辩分汇总</a>
							</td>
