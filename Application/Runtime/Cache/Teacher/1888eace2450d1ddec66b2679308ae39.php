<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
   ...
   <header>
   	    <hgroup>
   	    	<h1>分配学生</h1>
   	    	<h2>如果学生已选课题，则无法分配</h2>
   	    </hgroup>
   </header>
   <div>
   	   <form action="/biye/index.php/Teacher/Topic/giveStuAction" method="post">
   	   	   <input type="hidden" name="Cnum" value="<?php echo ($Cnum); ?>" />
   	   	   <input type="hidden" name="Tnum" value="<?php echo ($Tnum); ?>" />
   	   	   <input type="text" name="Snum" placeholder="请输入学号" style="margin-top:15px;width:40%" />
