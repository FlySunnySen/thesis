		...
		<section class="content">
			...
			<form id="news">
				<div class="field-wrap">
						<span>公告标题:</span>
						<input name="infonum" value="<?php echo ($infonum); ?>" type="hidden" />
						<input name="infotitle" value="<?php echo ($infotitle); ?>" type="text" />
			    ...
			    <button class="green" id="sub" style="margin-left: 48%;margin-top: 15px;">保存</button>
			</form>
			</div>
				...
				$(function(){
					$('#sub').bind('click',function(){
						...
						$.ajax({
							async : false,						   
							type:'POST',
							url:'/biye/index.php/Teacher/Information/saveNews',
							data:data,							
