	...
	<body>
		...
		<section class="content">
			<section class="widget">
				...
				<div class="content">
					<a href="/biye/index.php/Teacher/Information/add"><button class="green" style="margin-bottom: 10px;">新增公告</button></a>
					<table id="myTable">
						<thead>
							<tr>
								<td>公告编号</td>
						...
						<?php if(is_array($type)): foreach($type as $key=>$vo): ?><tr>
							...
							<td><a href="/biye/index.php/Teacher/Information/editInformationShow/infonum/<?php echo ($vo["infonum"]); ?>">修改</a> <a href="/biye/index.php/Teacher/Information/delectNews/infonum/<?php echo ($vo["infonum"]); ?>" style="margin-left: 15px;">删除</a></td>
